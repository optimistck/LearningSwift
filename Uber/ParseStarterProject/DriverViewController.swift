...
//
//  Created by Constantin on 1/10/17.
...
class DriverViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location = manager.location?.coordinate {
            ...
            query.whereKey("location", nearGeoPoint: PFGeoPoint(latitude: location.latitude, longitude: location.latitude))
            ...
            query.findObjectsInBackground(block: { (objects, error) in
                if let riderRequests = objects {
                    ...
                    for riderRequest in riderRequests {
                        ...
                        if let username = riderRequest["location"] as? String {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Find distance betweeen userLocation and requestLocations[indexPath.row]
        ...
        let roundedDistance = round(distance * 1000) / 100
