...
//
//  Created by Constantin on 12/27/16.
...
class UserTableViewController: UITableViewController {
    ...
    var username = [""]
    var userIDs = [""]
    var isFollowing = ["" : false] // dictionary
    ...
    func refresh() {
        ...
        query?.findObjectsInBackground(block: { (objects, error) in
            ...
            if error != nil {
                ...
                for object in users {
                    // see if individuals users can be casted into PFUser, and if they are, refer as PFuser
                    if let user = object as? PFUser {
                        
                        if user.objectId != PFUser.current()?.objectId {
                            
                            // use of "self" b/c in closure
