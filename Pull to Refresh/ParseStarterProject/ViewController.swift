    ...
    @IBAction func signupOrLogin(_ sender: AnyObject) {
        ...
        if emailTextField.text == "" || passwordTextField.text == "" {
            ...
            createAlert(title: "Error in form", message: "Please enter an email and password")
                ...
                UIApplication.shared.beginIgnoringInteractionEvents() // UIApplication.shared() changed to UIApplication.shared
            ...
            if signupMode {
                ...
                user.signUpInBackground(block: { (success, error) in
                    ...
                    UIApplication.shared.endIgnoringInteractionEvents() // UIApplication.shared() changed to UIApplication.shared
